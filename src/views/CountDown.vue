<template>
    <div class="text">
      <h5><b-badge variant="light" class="text-success" pill>Sale Ends In: {{ hours }} hrs:{{ minutes }} mins:{{ seconds }} secs</b-badge></h5>
    </div>
  </template>
  ...
  export default {
    ...
    computed: {
      ...
      minutes() {
        return String(Math.floor((this.timeRemaining % 3600) / 60)).padStart(2, "0");
      },
      seconds() {
